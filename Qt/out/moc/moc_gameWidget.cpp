...
QT_MOC_LITERAL(1, 15, 11), // "EmitEndGame"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 13), // "EmitPauzeGame"
QT_MOC_LITERAL(4, 42, 10) // "updateTime"

    },
    "mainGameWidget\0EmitEndGame\0\0EmitPauzeGame\0"
    "updateTime"
};
...
void mainGameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->EmitEndGame(); break;
        case 1: _t->EmitPauzeGame(); break;
        ...
        {
            typedef void (mainGameWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mainGameWidget::EmitEndGame)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (mainGameWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mainGameWidget::EmitPauzeGame)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void mainGameWidget::EmitEndGame()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void mainGameWidget::EmitPauzeGame()
{
