/********************************************************************************
** Form generated from reading UI file 'sidePanelWidget.ui'
**
...
#ifndef UI_SIDEPANELWIDGET_H
#define UI_SIDEPANELWIDGET_H
...
public:
    ...
    void setupUi(QWidget *sidePanelWidget)
    {
        if (sidePanelWidget->objectName().isEmpty())
            sidePanelWidget->setObjectName(QStringLiteral("sidePanelWidget"));
        sidePanelWidget->resize(541, 453);
        verticalLayout = new QVBoxLayout(sidePanelWidget);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        infoBox = new QVBoxLayout();
        infoBox->setObjectName(QStringLiteral("infoBox"));
        gridLayout = new QGridLayout();
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        gameTimeLabel = new QLabel(sidePanelWidget);
        ...
        lineEdit = new QLineEdit(sidePanelWidget);
        ...
        frame = new QFrame(sidePanelWidget);
        ...
        retranslateUi(sidePanelWidget);

        QMetaObject::connectSlotsByName(sidePanelWidget);
    } // setupUi

    void retranslateUi(QWidget *sidePanelWidget)
    {
        sidePanelWidget->setWindowTitle(QApplication::translate("sidePanelWidget", "Form", Q_NULLPTR));
        gameTimeLabel->setText(QApplication::translate("sidePanelWidget", "Game time", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("sidePanelWidget", "00:00:00", Q_NULLPTR));
        endGame->setText(QApplication::translate("sidePanelWidget", "End game", Q_NULLPTR));
        exitAplication->setText(QApplication::translate("sidePanelWidget", "Exit application", Q_NULLPTR));
        pauzeGame->setText(QApplication::translate("sidePanelWidget", "Pause", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class sidePanelWidget: public Ui_sidePanelWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SIDEPANELWIDGET_H
